...
\begin{description}[style=nextline, leftmargin=0pt]
  ...
  The model seeds the solver, which then runs to its usual tolerance.
  Measured by iterations and wall-clock time saved, with correctness
  guaranteed by the solver rather than by the model.
\end{description}
